...
//------------------------------------------------------------------------------
        ...
        Button btnMix = new Button("Mix Colors");
        // TODO - finish the button commands
        // when the button is clicked call the mixColors() method
        btnMix.setStyle("-fx-font-size: 18pt; -fx-padding: 10; -fx-text-fill: #0000ff;");
        btnMix.setOnAction((ActionEvent e) -> mixColors());

        HBox hBoxBtn = new HBox();
        hBoxBtn.setAlignment(Pos.CENTER);
        hBoxBtn.setSpacing(20);
        hBoxBtn.getChildren().addAll(rect, btnMix);
